/**
 * Group doc – Part 1: Add Group field, Display Name, Advanced, Multiple toggle
 * https://www.contentstack.com/docs/developers/create-content-types/group
 * Reuses module.selectors.ts; Group-specific targets from doc DOM.
 */
...
export const CLICK_SELECTORS: Record<string, string> = {
  ...
  "Multiple (doc step)":
    '[data-test-id="cs-ct-field-group-multiple-disabled"] label.toggle-switch input[type="checkbox"], [data-test-id="cs-ct-field-group-multiple-disabled"] .toggle-switch, [data-test-id="cs-ct-field-group-multiple-disabled"]',
};
