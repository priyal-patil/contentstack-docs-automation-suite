/**
 * Selectors for Website Header flow.
 * Doc: https://www.contentstack.com/docs/developers/content-modeling/website-header
 * Verifies Header content type fields from "Developing Content Type" section.
 * Note: App uses alt="wesbite-header.svg" (typo); also support website-header.svg.
 */
export const CLICK_SELECTORS: Record<string, string> = {
  ...
  "Website Header card (doc step)":
    '[role="dialog"] .content_model_card_component:has(img.ContentModel--banner[alt="wesbite-header.svg"]), [role="dialog"] .content_model_card_component:has(img.ContentModel--banner[alt="website-header.svg"]), [data-test-id="content-models-website-header-card"], [role="dialog"] [data-test-id*="website-header"]',
  "Schema tab (doc step)":
