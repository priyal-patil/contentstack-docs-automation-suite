export const CLICK_SELECTORS: Record<string, string> = {
  ...
  "New Environment (doc step)":
    '[data-test-id="cs-environment-empty-state-header-new-environment"], [data-test-id="cs-environment-empty-state-create"], button:has-text("New Environment")',
  ...
  "Create Environment modal (doc step)":
    '[data-test-id="cs-modal-title-create-environment"], h3:has-text("Create Environment")',
