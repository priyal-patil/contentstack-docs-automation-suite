export const CLICK_SELECTORS: Record<string, string> = {
  ...
  "Visual Experience from left nav (doc step)":
    'a.ListRowV2-wrapper:has([data-test-id="cs-stack-settings-visual-experience"]), [data-test-id="cs-stack-settings-visual-experience"], a[href*="/settings/visual-experience"]',
  "Visual Experience page title (doc step)":
    '[data-test-id="cs-page-title"]:has-text("Visual Experience"), .page-header-title:has-text("Visual Experience")',
  ...
  "Default Preview Environment dropdown (doc step)":
    '.general-settings-section-wrapper:has(h2.general-settings-section-title:has-text("Live Preview")) [data-test-id="cs-select"]',
  ...
  "Live Preview Display Setup Status toggle (doc step)":
    '.general-settings-section-wrapper:has(h2.general-settings-section-title:has-text("Live Preview")) [data-test-id="cs-toggle-switch"]',
