 ...
 * DOM: data/dom/BrandKit/kv-vert-ellip-menu.html
 */
...
export const CLICK_SELECTORS: Record<string, string> = {
  ...
  "Knowledge Vault Actions dropdown tooltip (export-item-from-knowledge-vault)":
    '[data-test-id="cs-vertical-action-tooltip"]',

  "Knowledge Vault Actions Export menu item (export-item-from-knowledge-vault)":
